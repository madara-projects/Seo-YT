...
[![GitHub stars](https://img.shields.io/github/stars/your-repo?style=flat-square&logo=github)](https://github.com/your-repo)
[![GitHub forks](https://img.shields.io/github/forks/your-repo?style=flat-square&logo=github)](https://github.com/your-repo/fork)
...
```mermaid
graph LR
    A["📝 Paste Script"] -->|Research| B["🔍 Competitor Data"]
    B -->|Analyze| C["📈 Market Intel"]
    C -->|Score| D["🎯 Opportunity"]
    D -->|Generate| E["✨ Upload Package"]
