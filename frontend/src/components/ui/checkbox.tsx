...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "group peer grid size-4.5 shrink-0 place-items-center rounded-[0.375rem] border border-input bg-card shadow-[0_1px_2px_oklch(0.2_0.03_286/0.06)] transition-colors",
